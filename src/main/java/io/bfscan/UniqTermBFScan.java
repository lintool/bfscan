...
public class UniqTermBFScan {

  private UniqTermBFScan() {}
  ...
  private static UniqTermRankerThread [] Thread;
  ...
  public static void main(String[] args) throws IOException {
    ...
    Thread = new UniqTermRankerThread[numThread];
    ...
    for(int i = 0; i < numThread; i++) {
      ...
      Thread[i] = new UniqTermRankerThread("Thread", start, end, keys, docs, freq, doclen, allQuery.query[j], numTopDoc, i, allScore);
      Thread[i].start();
    }
