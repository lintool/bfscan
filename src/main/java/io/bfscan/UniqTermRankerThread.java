...
public class UniqTermRankerThread implements Runnable {
  public Thread Thr;
  ...
  public UniqTermRankerThread(String name, int start, int end, String [] keys, int [][] docs, int [][] freq, int [] doclen, Query query, int numTopDoc, int thid, Score [] allScore){
      threadName = name;
      this.start = start;
      this.end = end;
      this.keys = keys;
